...
// +----------------------------------------------------------------------+
session_start();
if(!isset($_GET["token"]) ==='a205648033f766115436e339300d8257ff1312e0d512dd81d71972fda0bf1dd0'){
...
<BR><table cellspacing=0 cellpadding=0 width=666 border=0><tr><td class=cp width=150>
  <span class="campo"><IMG
      ...
      border=0></span></td>
<td width=3 valign=bottom><img height=22 src=imagens/3.png width=2 border=0></td><td class=cpt width=58 valign=bottom><div align=center><font class=bc><?php if(isset($dadosboleto["codigo_banco_com_dv"])){ echo $dadosboleto["codigo_banco_com_dv"];} ?></font></div></td><td width=3 valign=bottom><img height=22 src=imagens/3.png width=2 border=0></td><td class=ld align=right width=453 valign=bottom><span class=ld>
