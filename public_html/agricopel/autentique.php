...
if (is_null($signer1_retrieved) ) {
  $signer1 = (object) null;
  $signer1->signer = (object) array("email" => "gilberto@lawfinancas.com.br");
...
if (is_null($signer2_added["list"])) {
  ...
  $sql = "SELECT *, antecipadasDetalhes.descontoJuros as descontoJuros, antecipadas.descontoTaxas as descontoTaxas, antecipadas.valorOriginal as Original,   antecipadasDetalhes.valor as valor_antecip, ( select antecipadas.valor from antecipadas where id = ? ) as valor_antecip_liq FROM antecipadasDetalhes 
 ...
 $RESUMO = $antecip;
  ...
  $VALOR_LIQUIDO_OPERACAO= number_format($ANCORA, 2, ",", ".");
...
// echo $arq;
// $signers = "{\"email\":\"gilberto@lawfinancas.com.br\",\"action\":\"SIGN\"},{\"email\":\"$email\",\"action\":\"SIGN\"}";
