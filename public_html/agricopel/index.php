							...
							<div class="col-xl-4">
								...
								<a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
									...
									<div class="card-body">
										...
										<!--end::Svg Icon-->
										<div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5" id="limiteDisponivel">
										<?php
												...
												?>
												R$ <?php echo number_format($valormontante + $totalpago_query['total_pago'] - $total_operado - $total_postergadoValue, 2, ',', '.'); ?>
										</div>
	...
	<script>
		...
		if ($_SESSION["EfetuarOperacao"] == false) { ?>
			$(document).ready(function() {
				...
				$('.operacoes-check').on('click', function() {
