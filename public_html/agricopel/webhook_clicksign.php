...
if ($headers["Content-Hmac"] == "sha256=" . hash_hmac('sha256', $body, '0c4a76f3f58c4c3fb9d4965e96fb0c4a')) {
  ...
  if ($res['tipo'] == 'cliente') {
    ...
    $logContent = date("Y-m-d H:i:s") . " - Postergação Resultado para cnpj : " . var_export($cnpj, true) . PHP_EOL;
