...
<div class="modal-body" >
	<form method="post" action="?a=alterarDados&id=<?php echo $id; ?>" enctype="multipart/form-data">
		...
		<div class="row">
			<div class="col-md-6 col-6">
				<div class="form-group d-flex flex-column mb-8">
					<label class="fs-6 fw-bold mb-2" for="titulo">Limite (R$):</label>
					<input type="text" class="form-control form-control-solid" name="limite" value="<?php echo $busca_fornnecedores["limite"]; ?>">
				</div>
			</div>	
			<div class="col-md-6 col-6">
				<div class="form-group d-flex flex-column mb-8">
					<label class="fs-6 fw-bold mb-2" for="titulo">Taxa de Juros (%):</label>
					<input type="text" class="form-control form-control-solid" name="juros" id="jutos" value="<?php echo $busca_fornnecedores["juros"]; ?>">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="form-group d-flex flex-column mb-8">
					...
					<input type="text" step="any" class="form-control form-control-solid" name="banco" id="banco" value="<?php echo $busca_fornnecedores["banco"]; ?>">
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group d-flex flex-column mb-8">
					<label class="fs-6 fw-bold mb-2"  for="valor">Agencia: </label>
					<input type="text" step="any" class="form-control form-control-solid" name="agencia" id="agencia" value="<?php echo $busca_fornnecedores["agencia"]; ?>">
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group d-flex flex-column mb-8">
					<label class="fs-6 fw-bold mb-2"  for="valor">Conta: </label>
					<input type="text" step="any" class="form-control form-control-solid" name="conta" id="conta" value="<?php echo $busca_fornnecedores["conta"]; ?>">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="form-group d-flex flex-column mb-8">
					<label class="fs-6 fw-bold mb-2"  for="valor">Boleto (R$):</label>
					<input type="text" step="any" class="form-control form-control-solid" name="boleto" id="boleto" value="<?php echo $busca_fornnecedores["boleto"]; ?>">
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group d-flex flex-column mb-8">
					<label class="fs-6 fw-bold mb-2"  for="valor">TAC (R$):</label>
					<input type="text" step="any" class="form-control form-control-solid" name="tac" id="tac" value="<?php echo $busca_fornnecedores["tac"]; ?>">
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group d-flex flex-column mb-8">
					<label class="fs-6 fw-bold mb-2"  for="valor">TED (R$):</label>
					<input type="text" step="any" class="form-control form-control-solid" name="ted" id="ted" value="<?php echo $busca_fornnecedores["ted"]; ?>">
				</div>
			</div>
		</div>
