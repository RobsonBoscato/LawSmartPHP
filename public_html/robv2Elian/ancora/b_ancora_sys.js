function buscar(cnpj) {
	...
	const urls = [
		`fetchBycnpj.php?f=fornecedor&cnpj=${cnpj}`,
		`fetchBycnpj.php?f=operacoes&cnpj=${cnpj}`,
		`fetchBycnpj.php?f=baixadas&cnpj=${cnpj}`,
		`fetchBycnpj.php?f=taxas&cnpj=${cnpj}`,
		`fetchBycnpj.php?f=feriados&data=${dthj.getFullYear()}-${dthj.getMonth()+1}-${dthj.getDate()}`
	]
