<?php
  ...
  function formataCpfCnpj($str) {
    ...
    if (strlen($str) == 14 || strlen($str) == 13) {
  ...
  <p>
    <span class="under">CEDENTE SUB-ROGANTE:</span> ELIAN INDUSTRIA TEXTIL LTDA, pessoa jurídica de direito privado, devidamente inscrita perante o CNPJ/MF sob o nº 82.698.085/0001-98, com sede e foro na Rua Manoel Francisco da Costa, nº 215, CEP 89.257-000, Jaraguá do Sul – Estado de Santa Catarina.
    ...
    <br><span class="bold">Endereço:</span> Rua Manoel Francisco da Costa, nº 215, CEP 89.257-000, Jaraguá do Sul – Estado de Santa Catarina.
