...
$fornecedor = mysqli_fetch_assoc(mysqli_query($lawsmt, "SELECT * FROM fornecedores WHERE cnpj = '{$_SESSION['cnpj']}'"));
?>
<!DOCTYPE html>
<html lang="pt-br">
	<!--begin::Head-->
								...
								<div class="col-xl-4">
									...
									<a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
										...
										<div class="card-body">
											...
											<?php
												$totaloperado = mysqli_fetch_assoc(mysqli_query($lawsmt, "SELECT SUM(valorOriginal) as valor FROM antecipadas WHERE fornecedor = '{$_SESSION["id"]}'")) or die(mysqli_error());
											?>
								...
								<div class="col-xl-4">
									...
									<a href="#" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
										...
										<div class="card-body">
											...
											<!--end::Svg Icon-->
											<div class="text-white fw-bolder fs-2 mb-2 mt-5"><?php echo $fornecedor['taxaJuros']; ?>%</div>
											...
											<div class="table-responsive">
												...
												<table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
													...
													<tbody>
														...
														<?php
															$operacoes = mysqli_query($lawsmt, "select operacoes.*, 
																boletos.id as id_boleto 
																boletos.status as status_boleto,
																from operacoes
																left join boletos 
																  on operacoes.id = boletos.operacao
																where operacoes.cnpj like '{$_SESSION['cnpj']}'
														    ");
															while($row = mysqli_fetch_assoc($operacoes)) {
