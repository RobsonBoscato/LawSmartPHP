												...
												<div class="card-body p-0">
													...
													<div class="px-9 pt-7 card-rounded h-275px w-100 bg-primary">
														...
														<div class="d-flex text-center flex-column text-white pt-8">
															...
															<span class="fw-bolder fs-2x pt-1">R$ <?php echo number_format($totaloperado['valor'], 2, ',', '.'); ?></span>
														</div>
 													</div>
													
													
													<?php
														$antecipadas = mysql_query("SELECT * FROM antecipadas GROUP BY fornecedor ORDER BY valor DESC LIMIT 4");
														while($ant = mysql_fetch_assoc($antecipadas)) {
															$fornecedores = mysql_fetch_assoc(mysql_query("SELECT * FROM fornecedores WHERE id = '{$ant['fornecedor']}'"));
															$taa = mysql_fetch_assoc(mysql_query("SELECT SUM(valor) as valor FROM antecipadas WHERE fornecedor = '{$ant['fornecedor']}'"));
													?>
														...
														<div class="d-flex align-items-center mb-6">
															...
															<div class="d-flex align-items-center flex-wrap w-100">
																<div class="mb-1 pe-3 flex-grow-1">
																	<a href="#" class="fs-5 text-gray-800 text-hover-primary fw-bolder"><?php echo substr($fornecedores["razao"],0,18); ?>...</a>
																</div>
																<div class="d-flex align-items-center">
																	<div class="fw-bolder fs-5 text-gray-800 pe-1">R$ <?php echo number_format($taa['valor'], 2, ',', '.'); ?></div>
											...
											<div class="">
												<div class="card card-xl-stretch mb-xl-8">
													...
													<div class="card-body pt-5">
														...
														<div class="d-flex flex-stack">
															<!--begin::Title-->
															<h4 class="fw-bolder text-gray-800 m-0">Total Operado</h4>
														...
														<div class="text-center w-100 position-relative z-index-1" style="margin-top: -130px">
															<!--begin::Text-->
															<p class="fw-bold fs-4 text-gray-400 mb-6">Valores somados</p>
													...
													<div class="card-footer d-flex flex-center py-5">
														...
														<div class="d-flex align-items-center flex-shrink-0 me-7 me-lg-12">
															...
															<span class="fw-bold text-gray-400 fs-6">Considera amontoado</span>
															<!--end::Label-->
														</div>
													</div>
													<!--ed::Info-->
												...
												<div class="card card-xxl-stretch mb-5 mb-xl-8" style="background-color: #CBF0F4">
													...
													<div class="card-body d-flex flex-column">
														...
														<div class="d-flex flex-column flex-grow-1">
															<!--begin::Title-->
															<a href="#" class="text-dark text-hover-primary fw-bolder fs-3">Operação por Fornecedor</a>
															<!--end::Title-->
															<!--begin::Chart-->
														...
														<div class="pt-5">
															<!--begin::Number-->
															<span class="text-dark fw-bolder fs-3x me-2 lh-0">0.12</span>
															<!--end::Number-->
															<!--begin::Text-->
															<span class="text-dark fw-bolder fs-6 lh-0">+ 1% essa semana</span>
															<!--end::Text-->
														</div>
														<!--end::Stats-->
													</div>
											...
											<div class="">
												...
												<div class="card card-xl-stretch mb-xl-8" style="background-color: #CBF0F4">
													...
													<div class="card-body d-flex flex-column">
														...
														<div class="d-flex flex-column flex-grow-1">
															<!--begin::Title-->
															<a href="#" class="text-dark text-hover-primary fw-bolder fs-3">Novos Fornecedores</a>
															<!--end::Title-->
															<!--begin::Chart-->
														...
														<div class="pt-5">
															...
															<!--end::Symbol-->
															<!--begin::Number-->
															<span class="text-dark fw-bolder fs-3x me-2 lh-0">0</span>
															<!--end::Number-->
															<!--begin::Text-->
															<span class="text-dark fw-bolder fs-6 lh-0">+ 0% essa semana</span>
															<!--end::Text-->
														</div>
														<!--end::Stats-->
													</div>
											...
											<div>
												<a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
													...
													<div class="card-body">
														...
														<!--end::Svg Icon-->
														<div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">R$ <?php echo number_format("5000000" + $totaloperado['valor'], 2, ',', '.'); ?></div>
										...
										<div class="card-body py-3">
											...
											<div class="table-responsive">
												...
												<table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
													...
													<tbody>
														<?php
															$operacoes = mysql_query("SELECT * FROM operacoes ORDER BY vencimento DESC");
															while($ope = mysql_fetch_assoc($operacoes)) {
																$fornecedor = mysql_fetch_assoc(mysql_query("SELECT * FROM fornecedores WHERE cnpj = '{$ope['cnpj']}'"));
														?>
														<tr>
															<td>
															...
															<td>
																<a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6"><?php $data = new DateTime($ope['data']); echo $data->format('d-M-Y'); ?></a>
															</td>
															<td>
																<a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6"><?php echo $ope["valor"]; ?></a>
															</td>
															<td>
																<a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6"><?php echo $fornecedor["limite"]; ?></a>
															</td>
															<td>
																<a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6"><?php echo $fornecedor["taxaJuros"]; ?></a>
															</td>
															<td>
																<?php if($ope['status'] == '0') { ?>
				...
				<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
					...
					<form id="kt_modal_new_target_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
						...
						<div class="mb-13 text-center">
							<!--begin::Title-->
							<h1 class="mb-3">Edite as taxas desse fornecedor</h1>
							<!--end::Title-->
							<!--begin::Description-->
							<div class="text-muted fw-bold fs-5">Preencha os campos corretamente
							<a href="#" class="fw-bolder link-primary"> ou consulte ajuda</a>.</div>
							<!--end::Description-->
						</div>
						<!--end::Heading-->
						<!--begin::Input group-->
						<div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
							...
							<label class="d-flex align-items-center fs-6 fw-bold mb-2">
								<span class="required">Limite</span>
								<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="" data-bs-original-title="Limite de valor operado" aria-label="Limite de valor operado"></i>
							</label>
							<!--end::Label-->
							<input type="text" class="form-control form-control-solid" placeholder="Limite total" name="target_title">
						...
						<div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
							<!--begin::Label-->
							<label class="d-flex align-items-center fs-6 fw-bold mb-2">
								<span class="required">Taxa Juros</span>
								<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="" data-bs-original-title="digite"  aria-label="digite"></i>
							</label>
							<!--end::Label-->
							<input type="text" class="form-control form-control-solid" placeholder="Limite total" name="target_title">
						<div class="fv-plugins-message-container invalid-feedback"></div>
						...
						<div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
							<!--begin::Label-->
							<label class="d-flex align-items-center fs-6 fw-bold mb-2">
								<span class="required">Taxa TED</span>
								<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="" data-bs-original-title="digite"  aria-label="digite"></i>
							</label>
							<!--end::Label-->
							<input type="text" class="form-control form-control-solid" placeholder="Limite total" name="target_title">
						...
						<div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
							<!--begin::Label-->
							<label class="d-flex align-items-center fs-6 fw-bold mb-2">
								<span class="required">Taxa Boleto</span>
								<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="" data-bs-original-title="digite"  aria-label="digite"></i>
							</label>
							<!--end::Label-->
							<input type="text" class="form-control form-control-solid" placeholder="Limite total" name="target_title">
						...
						<div class="row g-9 mb-8">
							...
							<div class="col-md-6 fv-row fv-plugins-icon-container">
								<label class="required fs-6 fw-bold mb-2">Responsável</label>
								<select class="form-select form-select-solid select2-hidden-accessible" data-control="select2" data-hide-search="true" data-placeholder="Responsável" name="target_assign" data-select2-id="select2-data-7-g7ph" tabindex="-1" aria-hidden="true">
									<option value="" data-select2-id="select2-data-9-zpwt">Selecione o usuário</option>
							...
							<div class="col-md-6 fv-row">
								<label class="required fs-6 fw-bold mb-2">Bloquear até data ?</label>
								<!--begin::Input-->
						...
						<div class="d-flex flex-column mb-8">
							...
							<textarea class="form-control form-control-solid" rows="3" name="target_details" placeholder="Observação"></textarea>
						</div>
