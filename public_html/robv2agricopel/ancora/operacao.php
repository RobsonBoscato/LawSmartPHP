...
$id_postergacao = mysqli_escape_string($lawsmt, $_GET["id_postergacao"]);
...
if (is_null($id_postergacao) || strlen($id_postergacao) == 0) {

	$operacao  = mysqli_fetch_assoc(mysqli_query($lawsmt, "SELECT * FROM antecipadas WHERE id = '{$id}'"));
	$fornecedor  = mysqli_fetch_assoc(mysqli_query($lawsmt, "SELECT * FROM fornecedores WHERE id = '{$operacao['fornecedor']}'"));

} else {
	$operacao  = mysqli_fetch_assoc(mysqli_query($lawsmt, "SELECT *, juros as descontoJuros, taxas as descontoTaxas, (select cnpj from operacoes where operacoes.id = (select id_operacao from postergacoesDetalhes where postergacoesDetalhes.id_postergacao = postergacoes.id limit 1)) as cnpj FROM postergacoes WHERE id = '{$id_postergacao}'"));
	// echo "SELECT * FROM fornecedores WHERE cnpj like {$operacao['cnpj']} limit 1";
...
if (is_null($operacao)) {
	$operacao = mysqli_fetch_assoc(mysqli_query($lawsmt, "select operacoes.*, postergacoesDetalhes.valorOriginal as valorOriginal, sum(postergacoesDetalhes.juros) as descontoJuros, sum(postergacoesDetalhes.taxas) as descontoTaxas from operacoes
												...
												<div class="card-body p-0">
													...
													<div class="px-9 pt-7 card-rounded h-275px w-100 bg-primary">
														...
														<div class="d-flex flex-stack">
															<h3 class="m-0 text-white fw-bolder fs-3">Operação 000<?php echo $id; ?></h3>
															
														</div> 
														<div class="d-flex text-center flex-column text-white pt-8">
															<span class="fw-bold fs-7">Valor da Operação</span>
															<span class="fw-bolder fs-2x pt-1">R$ <?php echo number_format($operacao['valor'], 2, ',', '.'); ?></span>
														</div>
 													</div>
														...
														<div class="d-flex align-items-center mb-6">
															...
															<div class="d-flex align-items-center flex-wrap w-100">
																...
																<div class="d-flex align-items-center">
																	<div class="fw-bolder fs-5 text-gray-800 pe-1">R$ <?php echo number_format($operacao['valorOriginal'], 2, ',', '.'); ?></div>
													...
													<div class="bg-body shadow-sm card-rounded mx-9 mb-9 px-6 py-9 position-relative z-index-1" style="margin-top: -90px">
														<div class="d-flex align-items-center mb-6">
															...
															<div class="d-flex align-items-center flex-wrap w-100">
																...
																<div class="d-flex align-items-center">
																	<div class="fw-bolder fs-5 text-gray-800 pe-1">R$ <?php echo number_format($operacao['descontoJuros'], 2, ',', '.'); ?></div>
																	<span class="svg-icon svg-icon-5 svg-icon-success ms-1">
																		<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
																			<rect opacity="0.5" x="13" y="6" width="13" height="2" rx="1" transform="rotate(90 13 6)" fill="black" />
																			<path d="M12.5657 8.56569L16.75 12.75C17.1642 13.1642 17.8358 13.1642 18.25 12.75C18.6642 12.3358 18.6642 11.6642 18.25 11.25L12.7071 5.70711C12.3166 5.31658 11.6834 5.31658 11.2929 5.70711L5.75 11.25C5.33579 11.6642 5.33579 12.3358 5.75 12.75C6.16421 13.1642 6.83579 13.1642 7.25 12.75L11.4343 8.56569C11.7467 8.25327 12.2533 8.25327 12.5657 8.56569Z" fill="black" />
													...
													<div class="bg-body shadow-sm card-rounded mx-9 mb-9 px-6 py-9 position-relative z-index-1" style="margin-top: -90px">
														<div class="d-flex align-items-center mb-6">
															...
															<div class="d-flex align-items-center flex-wrap w-100">
																...
																<div class="d-flex align-items-center">
																	<div class="fw-bolder fs-5 text-gray-800 pe-1">R$ <?php echo number_format($operacao['descontoTaxas'], 2, ',', '.'); ?></div>
																	<span class="svg-icon svg-icon-5 svg-icon-success ms-1">
																		<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
																			<rect opacity="0.5" x="13" y="6" width="13" height="2" rx="1" transform="rotate(90 13 6)" fill="black" />
																			<path d="M12.5657 8.56569L16.75 12.75C17.1642 13.1642 17.8358 13.1642 18.25 12.75C18.6642 12.3358 18.6642 11.6642 18.25 11.25L12.7071 5.70711C12.3166 5.31658 11.6834 5.31658 11.2929 5.70711L5.75 11.25C5.33579 11.6642 5.33579 12.3358 5.75 12.75C6.16421 13.1642 6.83579 13.1642 7.25 12.75L11.4343 8.56569C11.7467 8.25327 12.2533 8.25327 12.5657 8.56569Z" fill="black" />
															...
															<div class="d-flex align-items-center flex-wrap w-100">
																...
																<div class="d-flex align-items-center">
																	<div class="fw-bolder fs-5 text-gray-800 pe-1">
																		<?php
																		// echo "SELECT count(*) as totaldupli FROM antecipadasDetalhes left join boletos on operacao = {$id} WHERE antecipada = '{$id}'";
																			$quantidade = mysqli_fetch_assoc(mysqli_query($lawsmt, "select count(*) as totaldupli from antecipadasDetalhes 
												...
												<div class="col-xl-6">
													...
													<a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
														...
														<div class="card-body">
															...
															<?php
																$totaloperado = mysqli_fetch_assoc(mysqli_query($lawsmt, "SELECT SUM(valor) as valor FROM antecipadas WHERE fornecedor = '{$fornecedor['id']}'")) or die(mysql_error());
																$totaloperado_postergacao = mysqli_fetch_assoc(mysqli_query($lawsmt, "select sum(valor) as valor from postergacoesDetalhes where postergacoesDetalhes.id_operacao = '{$operacao['id']}'")) or die(mysql_error());
																$valormontante=($totaloperado["valor"] + $totaloperado_postergacao['valor']);
															?>
															<div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">R$ <?php echo number_format($operacao['valorOriginal'], 2, ',', '.'); ?></div>
															...
															<tbody>
																<?php
																	...
																	if (is_null($id_postergacao) || strlen($id_postergacao) == 0) {
																		...
																		$operacoes = mysqli_query($lawsmt, "SELECT antecipadasDetalhes.*, 
																		...
																		// if no antecipação 
																		if (mysqli_num_rows($operacoes) == 0) {
																			if (is_null($id_postergacao) || strlen($id_postergacao) == 0) {
																				$operacoes = mysqli_query($lawsmt, "SELECT *, documento as nota, valor as valorOriginal FROM boletos WHERE operacao = '{$id}'") or die(mysqli_error());
																				$is_postergacao = true;
																			} 
																		}

																		$total_rows = mysqli_num_rows($operacoes);
																		while($ope = mysqli_fetch_assoc($operacoes)) {
																			//
																			if ($is_postergacao) {
																				$ape = mysqli_fetch_assoc(mysqli_query($lawsmt, "SELECT *, boletos.status as status_boleto, boletos.id as id_boleto, postergacoesDetalhes.taxas as taxas, postergacoesDetalhes.juros as juros, postergacoesDetalhes.valorOriginal as valorOriginal FROM operacoes  left join boletos on boletos.operacao = operacoes.id inner join postergacoesDetalhes on postergacoesDetalhes.id_operacao = operacoes.id WHERE operacoes.id = '{$ope['operacao']}'"));
																				...
																				$ape = mysqli_fetch_assoc(mysqli_query($lawsmt, "SELECT *, boletos.status as status_boleto, boletos.id as id_boleto FROM operacoes left join boletos on boletos.operacao = operacoes.id inner join antecipadasDetalhes on antecipadasDetalhes.operacao = operacoes.id WHERE operacoes.id = '{$ope['operacao']}'"));
																	...
																	<tr>
																		...
																		<td>
																			<?php
																				...
																				?>
																					<a href="imprime_boleto.php?id=<?php echo $ape['id_boleto']; ?>">
																	...
																	<tr>
																		...
																		<td>
																			<?php
																				?>
																					<a href="imprime_boleto.php?id=<?php echo $ape['boleto_id']; ?>">
																						<button data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="right" title="Imprimir Boleto" class="btn btn-active-icon-primary btn-active-text-primary" style="margin:0; padding:0;" id="efetuar-antecipadas">
																							<span class="svg-icon svg-icon-muted svg-icon-1hx">
																								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 409.6 404.3"><path class="svg-fill" d="M378.8 88.8h-55.1v75.8c0 10.5-8.5 18.9-19 18.9h-200c-10.5 0-19-8.5-19-18.9V88.8h-55c-10.5 0-18.9 8.5-19 18.9v186c0 10.5 8.5 18.9 18.9 19h348.1c10.5 0 18.9-8.5 19-19V107.8c.1-10.5-8.4-19-18.9-19z"/><path class="svg-stroke" d="M409.6 226V107.8c0-17-13.8-30.8-30.8-30.8h-43.2V30.8c0-17-13.8-30.8-30.8-30.8H149.2c-8.2 0-16 3.2-21.8 9L83 53.6c-5.8 5.8-9 13.6-9 21.7V77H30.8C13.8 77 0 90.8 0 107.8v185.9c0 17 13.8 30.8 30.8 30.8h281.1v49c0 3.9-3.2 7.1-7.1 7.1h-200c-3.9 0-7.1-3.2-7.1-7.1v-13.9c0-6.5-5.3-11.8-11.8-11.8-6.5 0-11.8 5.3-11.8 11.8v13.9c0 17 13.8 30.8 30.8 30.8h200c17 0 30.8-13.8 30.8-30.8v-49h43.2c17 0 30.8-13.8 30.8-30.8v-67.5c-.1-.1-.1-.2-.1-.2zM97.7 75.3c0-1.9.7-3.7 2.1-5l44.4-44.5c1.3-1.3 3.1-2.1 5-2.1h155.6c3.9 0 7.1 3.2 7.1 7.1v133.8c0 3.9-3.2 7.1-7.1 7.1h-200c-3.9 0-7.1-3.2-7.1-7.1V75.3zm281.1 225.5h-348c-3.9 0-7.1-3.2-7.1-7.1v-55.9h50.2c6.5 0 11.8-5.3 11.8-11.8 0-6.5-5.3-11.8-11.8-11.8H23.7V107.8c0-3.9 3.2-7.1 7.1-7.1H74v64c0 17 13.8 30.8 30.8 30.8h200c17 0 30.8-13.8 30.8-30.8v-64h43.2c3.9 0 7.1 3.2 7.1 7.1v106.4h-50.2c-6.5 0-11.8 5.3-11.8 11.8 0 6.5 5.3 11.8 11.8 11.8h50.2v55.9c0 3.9-3.2 7.1-7.1 7.1z"/></svg>
																							</span>
