...
$sql = "SELECT * FROM boletos left join clientes cli on cli.cnpj = boletos.cnpj left join fornecedores on fornecedores.cnpj = boletos.cnpj and fornecedores.tipo = 'cliente' WHERE boletos.id LIKE ?";
...
$dadosboleto["cedente"] = "FIXTECH INVESTIMENTOS LTDA";


// hard-coded
$dadosboleto["agencia"] = '8453';
$dadosboleto["conta"] = '21624';
...
function digitoVerificador_barra($numero) {
	...
	$resto2 = modulo_11(intval($numero), 9, 1);
	$digito = 11 - $resto2;
...
<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
  <tr>
    <td class=ti width=455><?php   echo isset($dadosboleto["identificacao"]) ? "<br>".$dadosboleto["identificacao"] : ''?> <?php echo isset($dadosboleto["cpf_cnpj"]) ? "<br>".$dadosboleto["cpf_cnpj"] : '' ?><br>
...
número</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top  width=113 height=12><div align=left>
  ...
  <td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top  width=62 height=12><div align=left><span class="campo">
    <?php if(isset($dadosboleto["especie_doc"])){ echo $dadosboleto["especie_doc"];}else{ echo '';}?>
  </span>
 ...
 <?php   if(isset($dadosboleto["aceite"])){ echo $dadosboleto["aceite"];}else{ echo '';} ?>
 </span>
   ...
   <span class="campo">
   <?php  if(isset($dadosboleto["data_processamento"])){ echo $dadosboleto["data_processamento"];}else{ echo '';}?>
...
<?php echo $dadosboleto["especie"]?>
 ...
 <td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top  width=72>
   <span class="campo">
   <?php  if(isset($dadosboleto["valor_unitario"])){ echo $dadosboleto["valor_unitario"];}else{ echo '';}?>
   </span></td>
 <td class=cp valign=top width=7 height=12> <img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top align=right width=180 height=12>
   <span class="campo">
   <?php echo $dadosboleto["valor_boleto"]?>
