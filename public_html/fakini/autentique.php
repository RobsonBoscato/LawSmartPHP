...
if (is_null($signer1_retrieved)) {
  ...
  $signer1->signer->name = "RAFAEL ENRICO FACHINI";
...
$addListSigner1->list->name = "RAFAEL ENRICO FACHINI";
...
if (is_null($signer2_added["list"])) {
  ...
  $sql = "SELECT *, antecipadasDetalhes.descontoJuros as descontoJuros, antecipadas.descontoTaxas as descontoTaxas, antecipadasDetalhes.valorOriginal as Original,   antecipadasDetalhes.valor as valor_antecip, ( select antecipadas.valor from antecipadas where id = ? ) as valor_antecip_liq FROM antecipadasDetalhes 
