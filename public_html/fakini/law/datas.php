										...
										<div class="card-body py-3">
											...
											<form method="post" action="?acao=cadastrar_fim" enctype="multipart/form-data">
											 ...
											 <?php break; case "cadastrar_fim":
												...
												$sql = mysql_query("INSERT INTO data (tipo, titulo, data) VALUES ('{$tipo}', '{$titulo}', '{$data}')") or die (mysql_error());
										...
										<div class="card-body py-3">
											...
											<div class="table-responsive">
												...
												<table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
													...
													<tbody>
														<?php
															$fornecedores = mysql_query("SELECT * FROM data");
															while($row = mysql_fetch_assoc($fornecedores)) {
