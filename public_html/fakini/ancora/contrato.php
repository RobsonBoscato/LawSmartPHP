...
$cnpj = $dados['cnpj']; //id antecipacao

if (isset($_GET['cnpj'])) {
  $id = $_GET['id']; //id antecipacao
  $cnpj = $_GET['cnpj']; //id antecipacao

}
if (empty($cnpj)) {
  echo json_encode($cnpj, JSON_FORCE_OBJECT);;
  return;
  exit;
}
...
{
  if ($str === null) {
    return ''; // or handle the null case in a way that makes sense for your application
  }
