														...
														<div class="d-flex align-items-center mb-6">
															...
															<div class="d-flex align-items-center flex-wrap w-100">
																...
																<div class="d-flex align-items-center">
																	<div class="fw-bolder fs-5 text-gray-800 pe-1">R$ <?php if($taa['valor'] > 0){  echo number_format($taa['valor'], 2, ',', '.');}else{ echo '0,00';} ?></div>
												...
												<div>
													<a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
														...
														<div class="card-body">
															...
															// $total_antecipado = $total_antecipado->Total_AntecipadoAncora();
															?>
															<div class="text-white fw-bolder fs-2 mb-2 mt-5">R$ <?php  echo number_format($total_postergado['valor'] + $total_antecipado['valor'], 2, ',', '.');//if($total_antecipado['valor'] > 0){ echo number_format($total_antecipado['valor'] + $total_postergado['valor'], 2, ',', '.');}else{ echo '0,00';} ?></div>
												...
												<div>
													<a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
														...
														<div class="card-body">
															...
															?>
															<?php  ?>
															<div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">R$ <?php if($TT > 0){ echo number_format($TT, 2, ',', '.');}else{ echo "0,00";} ?></div>
											...
											<div class="table-responsive">
												...
												<table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="kt_datatable_example_1">
													...
													<tbody>
														<?php
														$hoje = date("Y-m-d");
														$hoje_mais_10_dias = date("Y-m-d", strtotime($hoje . " +10 days"));
