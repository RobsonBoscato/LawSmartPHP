...
class AuthLaw extends ConexaoMysqlAncora
{
        ...
        if ($res) {
            ...
            $token = (new JwtFacade())->issue(
                ...
                static fn (
                    ...
                    ->issuedBy('https://fixtechapi.lawsmart.com.br')
    ...
    public function validation()
    {
        ...
        if (!$validator->validate($token, new RelatedTo('a205648033f766115436e339300d8257ff1312e0d512dd81d71972fda0bf1dd0'))) {
            return true;
        } else {
            return false;
        }
    ...
    public function clientesPage()
    {
        ...
        if ($validator->validate($token, new RelatedTo('a205648033f766115436e339300d8257ff1312e0d512dd81d71972fda0bf1dd0'))) {
            ...
            // Chamando o método SelectTipo com os parâmetros de offset e limite
            $re = $cliente->SelectTipo2($offset, $limit);
            if ($re) {
                // Define o cabeçalho Content-Type como application/json
                header('Content-Type: application/json');

                // Cria um array associativo com a mensagem desejada
                $response = array("status" => 200, "data" => $re);
