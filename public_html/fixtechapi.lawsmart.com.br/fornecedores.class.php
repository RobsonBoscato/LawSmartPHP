...
class fornecedores extends ConexaoMysql
{
    ...
    public function SelectTipo($offset =0, $limit=20)
    {
        ...
        $fornecedores = $this->pdo->prepare("SELECT * FROM fornecedores WHERE tipo = :tipo LIMIT :limit OFFSET :offset");
        $fornecedores->bindValue(':tipo', $this->getTipo());
        $fornecedores->bindValue(':limit', $limit, PDO::PARAM_INT);
        $fornecedores->bindValue(':offset', $offset, PDO::PARAM_INT);
    ...
    public function SelectTipo2($offset, $limit)
    {
        // Calcula o offset com base no número da página e no número de resultados por página
