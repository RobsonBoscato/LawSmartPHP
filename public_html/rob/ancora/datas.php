...
if($acao == 'excluir') {
	...
	$query = mysqli_query($lawsmt, "DELETE FROM data WHERE id = '{$id}'");
										...
										<div class="card-body py-3">
											...
											<form method="post" action="?acao=cadastrar_fim" enctype="multipart/form-data">
											 ...
											 <?php break; case "cadastrar_fim":
												...
												$sql = mysqli_query($lawsmt, "INSERT INTO data (tipo, titulo, data) VALUES ('{$tipo}', '{$titulo}', '{$data}')") or die (mysqli_error());
										...
										<div class="card-body py-3">
											...
											<div class="table-responsive">
												...
												<table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
													...
													<tbody>
														<?php
															$fornecedores = mysqli_query($lawsmt, "SELECT * FROM data ORDER BY data DESC");
