...
$fornecedor  = mysqli_fetch_assoc(mysqli_query($lawsmt, "SELECT * FROM fornecedores WHERE id = '{$id}'"));
...
<html lang="en">
	...
	if($acao == 'alterarDados') {
		...
		$banco = mysqli_escape_string($lawsmt, $_POST['banco']);
		$agencia = mysqli_escape_string($lawsmt, $_POST['agencia']);
		$conta = mysqli_escape_string($lawsmt, $_POST['conta']);

		$query = mysqli_query($lawsmt, "UPDATE fornecedores SET conta = '{$conta}', banco = '{$banco}', agencia = '{$agencia}', representante = '{$representante}', cpf = '{$cpf}', telefone = '{$telefone}', email = '{$email}', rua = '{$rua}', numero = '{$numero}', bairro = '{$bairro}', cidade = '{$cidade}', estado = '{$estado}', limite = '{$limite}', juros = '{$juros}', boleto = '{$boleto}', tac = '{$tac}', ted = '{$ted}' WHERE id = '{$id}'");
		echo var_dump($query);
										...
										<div class="notice d-flex bg-light-warning rounded border-warning border border-dashed p-6">
											...
											<div class="d-flex flex-stack flex-grow-1">
												...
												<div class="fw-bold">
													...
													<div class="fs-6 text-gray-700">Cliente já utilizou mais de 80% do limite disponível.</div>
												</div>
												<!--end::Content-->
											</div>
											<!--end::Wrapper-->
										...
										<div class="col-xl-6">
											...
											<a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
												...
												<div class="card-body">
													...
													<?php
														$totaloperado = mysqli_fetch_assoc(mysqli_query($lawsmt, "SELECT SUM(valor) as valor FROM antecipadas WHERE fornecedor = '{$id}'")) or die(mysql_error());
											...
											<div class="table-responsive">
												...
												<table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3"  id="kt_datatable_example_1">
													...
													<tbody>
														...
														<?php
															$antecipadas = mysqli_query($lawsmt, "SELECT * FROM antecipadas WHERE fornecedor = '{$id}' ORDER BY data DESC");
										...
										<div class="card-body py-3">
											...
											<div class="table-responsive">
												...
												<table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="kt_datatable_example_2">
													...
													<tbody>
														<?php
															$operacoes = mysqli_query($lawsmt, "SELECT * FROM operacoes WHERE cnpj = '{$fornecedor['cnpj']}' ORDER BY vencimento DESC");
														...
														<tr>
															...
															<td>
																<a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6"><?php echo date('d/m/Y', strtotime($ope["vencimento"])); ?></a>
															</td>
