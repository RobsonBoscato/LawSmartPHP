...
class AuthLaw extends ConexaoMysqlAncora
{
    ...
    public function validation()
    {
        ...
        if ($validator->validate($token, new RelatedTo('f25661dbf0f02deed530d561f411f622157fe8f675be98a7a3e955f7eed06011'))) {
            http_response_code(200); // Unauthorized
            header('Content-Type: application/json');
            echo json_encode(array("message" => "Token JWT válido."));
        } else {
