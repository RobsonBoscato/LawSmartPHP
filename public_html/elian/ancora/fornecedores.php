									...
									<div class="col-xl-6">
										...
										<a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
											...
											<div class="card-body">
												...
												?>
												<div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">R$ <?php if($valormontante > 0){ echo number_format($valormontante, 2, ',', '.');}else{ echo "0,00";} ?></div>
									...
									<div class="col-xl-6">
										...
										<a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
											...
											<div class="card-body">
												...
												?>
												<div class="text-white fw-bolder fs-2 mb-2 mt-5">R$ <?php if($totaloperado['valor'] > 0){ echo number_format($totaloperado['valor'], 2, ',', '.');}else{ echo '0,00';} ?></div>
													...
													<tbody>
														...
														?>
															<tr>
																...
																<td class="text-dark fw-bolder text-hover-primary fs-6">R$ <?php if($totaloperado['valor'] >0){echo number_format($totaloperado['valor'], 2, ',', '.');}else{ echo "0,00";} ?></td>
																<td>
