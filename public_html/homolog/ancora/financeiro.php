...
if($acao == 'excluir') {
	...
	$query = mysqli_query($lawsmt, "DELETE FROM movimentacao WHERE id = '{$id}'");
										...
										<div class="card-body py-3">
											...
											<form method="post" action="?acao=cadastrar_fim" enctype="multipart/form-data">
											  ...
											  <div class="form-group d-flex flex-column mb-8">
												...
												<input type="number" step="any" class="form-control form-control-solid" name="valor" id="valor">
											  </div>
											  <div class="form-group d-flex flex-column mb-8">
											 ...
											 <?php break; case "cadastrar_fim":
                                                        
											
												$tipo 		= mysqli_real_escape_string($lawsmt, $_POST['tipo']);
												$titulo 	= mysqli_real_escape_string($lawsmt, ($_POST['titulo']));
												$data 		= mysqli_real_escape_string($lawsmt, ($_POST["data"]));
												$valor 		= mysqli_real_escape_string($lawsmt, $_POST["valor"]);
												
												$sql = mysqli_query($lawsmt, "INSERT INTO movimentacao (tipo, titulo, data, valor) VALUES ('{$tipo}', '{$titulo}', '{$data}', '{$valor}')") or die (mysqli_error());
										...
										<div class="card-body py-3">
											...
											<div class="table-responsive">
												...
												<table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
													...
													<tbody>
														<?php
															$fornecedores = mysqli_query($lawsmt, "SELECT * FROM movimentacao");
														...
														<tr>
															...
															<td>
																<a href="#" class="text-dark fw-bolder text-hover-primary fs-6"><?php $data = new DateTime($row['data']); echo $data->format('d/m/Y'); ?></a>
															</td>
